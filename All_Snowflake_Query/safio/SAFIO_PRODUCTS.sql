create table SAFIO_PRODUCTS (SKU VARCHAR(36),DESCRIPTION VARCHAR(50),PRODUCTUNITOFMEASURE VARCHAR(5),UNITCOST NUMBER(28,2),
                            RETAILPRICE NUMBER(28,2),WHOLESALEPRICE NUMBER(28,2),DROPSHIPPRICE NUMBER(28,2),ASSEMBLYCOST NUMBER(28,2),
                            planner varchar default null,productId varchar default null,fileUpdate timestamp default null,SkuStatus varchar default null,
                             ATTR1 NUMBER(28,4), ATTR2 NUMBER(28,4),ATTR3 NUMBER(28,4),ATTR4 VARCHAR(1),ATTR5 VARCHAR(30),ATTR6 VARCHAR(30),
...
INSERT INTO SAFIO_PRODUCTS (SKU,DESCRIPTION,PRODUCTUNITOFMEASURE,UNITCOST,RETAILPRICE,WHOLESALEPRICE,DROPSHIPPRICE,ASSEMBLYCOST,
  ...
  WITH cte AS
    (select SKU as sku,DESCRIPTN as description, QTY_INSTOCKUM as productUnitOfMeasure ,
...
COPY INTO @adp/adp/SAFIO_PRODUCTS/products_250.csv from (select * from safio_products limit 250)
