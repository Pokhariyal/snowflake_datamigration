create view vpurchaseorder as select a.DOC_NO
,a.PARENT_DOC_NO
...
,a.TEL_PFIX
,a.WEB_SITE
,a.ZIP from purchaseorder a where lower(name) in ('duncan aviation','precision accessories & instruments',
'p&wc leasing',
'mint turbines llc',
