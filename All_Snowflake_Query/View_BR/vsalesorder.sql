create view vsalesorder as select a.DOC_NO
,a.PARENT_DOC_NO
...
,a.TEL_PFIX
,a.WEB_SITE
,a.ZIP from salesorder a where lower(name) in ('duncan aviation',
